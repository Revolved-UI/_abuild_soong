...
func Banner(make_vars map[string]string) string {
        b := &bytes.Buffer{}
                ...
                fmt.Fprintln(b, "                            ╚═════╝ ╚═╝                           ")
                fmt.Fprintln(b, "==================================================================")
                fmt.Fprintln(b, "                     REVOLVED-UI by SharmagRit                    ")
                fmt.Fprintln(b, "==================================================================")
                fmt.Fprintf(b, "%s=%s\n", "REVOLVED_BUILD_INFO", make_vars["REVOLVED_BUILD_INFO"])
                fmt.Fprintf(b, "%s=%s\n", "REVOLVED_BUILD_TYPE", make_vars["REVOLVED_BUILD_TYPE"])
                fmt.Fprintf(b, "%s=%s\n", "REVOLVED_MAINTAINER", make_vars["REVOLVED_MAINTAINER"])
